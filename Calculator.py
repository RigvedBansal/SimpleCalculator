...
if __name__ == "__main__": 
    ...
    expression_field = Entry(gui, textvariable=equation,width=50) 
    ...
    plus = Button(gui, text=' + ',   
                  command=lambda: press("+") , padx = 40,pady = 20 ) 
    ...
    equal = Button(gui, text=' = ',   
                   command=equalpress  , padx = 40,pady = 20) 
    equal.grid(row=5, column=2) 
  
    clear = Button(gui, text='Clear',   
                   command=clear , padx = 40,pady = 20 ) 
